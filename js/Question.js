class Question {
  ...
  display() {
    ...
    this.question.html("Question:- What going up but never goes down? ");
    this.question.position(150, 80);
    this.option1.html("1: Candle ");
    this.option1.position(150, 100);
    this.option2.html("2: Your Age");
    this.option2.position(150, 120);
    this.option3.html("3: Friends");
    this.option3.position(150, 140);
    this.option4.html("4: Toys");
    this.option4.position(150, 160);

    this.owner.html("by Teja R");
